...
export default function NotificationBell() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="fixed left-1 top-14 md:left-auto md:absolute md:right-0 md:top-12 w-[calc(100vw-8px)] md:w-96 bg-white rounded-xl border border-[var(--color-border)] shadow-xl z-[200] overflow-hidden">
          {/* Header */}
